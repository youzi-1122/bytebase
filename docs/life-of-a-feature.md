...
1. Write technical design docs.
   ...
   - Design API by following [API style guide](https://github.com/youzi-1122/bytebase/blob/main/docs/api-style-guide.md)
...
1. Coding.
   ...
   - Guard new features behind a release flag, especially for frontend using [`isDev()`](https://github.com/youzi-1122/bytebase/blob/4fd7ea41a716dbd72c85b0bc02f04fff5e08370f/frontend/src/main.ts#L41). We should release the feature only when it's mature.
