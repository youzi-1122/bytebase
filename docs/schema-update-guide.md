...
All schemas are located at [store/migration](https://github.com/youzi-1122/bytebase/tree/main/store/migration). Bytebase schema release follows semantic versioning.

Prod

- [prod](https://github.com/youzi-1122/bytebase/tree/main/store/migration/prod) schema.
...
- [dev](https://github.com/youzi-1122/bytebase/tree/main/store/migration/dev) schema.
...
- [Dev demo data](https://github.com/youzi-1122/bytebase/tree/main/store/demo/dev).
- [Prod demo data](https://github.com/youzi-1122/bytebase/tree/main/store/demo/prod).
...
4. Since we use the same code for both dev and release schemas, we should add if-else branching to read storage differently based on schema version, such as [this example](https://github.com/youzi-1122/bytebase/pull/1039).
