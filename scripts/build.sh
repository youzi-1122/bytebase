...
flags="-X 'github.com/youzi-1122/bytebase/bin/server/cmd.version=${VERSION}'
-X 'github.com/youzi-1122/bytebase/bin/server/cmd.goversion=$(go version)'
-X 'github.com/youzi-1122/bytebase/bin/server/cmd.gitcommit=$(git rev-parse HEAD)'
-X 'github.com/youzi-1122/bytebase/bin/server/cmd.buildtime=$(date -u +"%Y-%m-%dT%H:%M:%SZ")'
-X 'github.com/youzi-1122/bytebase/bin/server/cmd.builduser=$(id -u -n)'"
